...
public:
    ...
    // Active Room Config
    void        setActiveRoom(const QString& hallID, const QString& roomID, int rows, int cols, const QString& venueName = "");
    ...
    // Conflict detection
    QList<QPair<int,int>> detectConflicts();  // returns pairs of conflicting UIStudent ids
